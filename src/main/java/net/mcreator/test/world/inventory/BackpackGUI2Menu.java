...
import net.mcreator.test.procedures.BackpackGUIThisGUIIsClosedProcedure;
...
public class BackpackGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BackpackGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TestModMenus.BACKPACK_GUI_2.get(), id);
	...
	public void removed(Player playerIn) {
		...
		BackpackGUIThisGUIIsClosedProcedure.execute(world, entity);
